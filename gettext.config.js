...
module.exports = {
  input: {
    path: "./arches_nested_tile_csv_importer/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_nested_tile_csv_importer/locale", // output path of all created files
